                    ...
                    <div class="col-sm-7">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <form id="filter" class="form-horizontal" method="post" action="meals/filter">
                                    ...
                                    <%--<div>--%>
                                        <%--<input type="hidden" name="_csrf" value="0eaf1ed9-5ec8-46d9-b1e5-59baf8d47fbf"/>--%>
                                    <%--</div>--%>
                                </form>
                            </div>
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <a class="btn btn-primary" type="button" onclick="between()">
