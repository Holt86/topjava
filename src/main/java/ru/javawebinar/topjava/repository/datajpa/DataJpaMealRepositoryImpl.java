...
public class DataJpaMealRepositoryImpl implements MealRepository {
    ...
    private static final Sort SORT_BY_DATA = new Sort(Sort.Direction.DESC,"date_time");
    ...
    public Meal get(int id, int userId) {
        return DataAccessUtils.singleResult(crudRepository.findByIdAndUserId(id, userId));
    }
