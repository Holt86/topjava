...
public class MealTestData {
    ...
    public static final Collection<Meal> MEALS_COLLECTION = MEALS;
    public static final List<MealWithExceed> MEALS_WITH_EXCEED = MealsUtil.getWithExceeded(MEALS_COLLECTION, UserTestData.USER.getCaloriesPerDay());

    public static final List<MealWithExceed> BETWEEN = Arrays.asList(createWithExceed(MEAL5, true), createWithExceed(MEAL4, true) );
